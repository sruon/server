...
{
    {
        ...
        acceptIf = function(player, npc)
            return xi.einherjar.settings.EINHERJAR_ENABLED and
                xi.einherjar.meetsRequirementsForReservation(player)
        end,
...

    {
        ...
        acceptIf = function(player, npc)
            ...
            -- Stash on localVars so onFinish can use them after the event.
        ...
        event =
        {
            ...
            onFinish = function(player, option, npc)
                ...
                -- Lamp returns to the player regardless.
                return false
            end,
        },
    },
