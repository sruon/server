...
zones[xi.zone.HAZHALM_TESTING_GROUNDS] =
{
    text =
    {
        ...
        OBTAINS_TEMP_ITEM             = 7994, -- Obtained temporary item: <item>.
    ...
    mob =
    {
        ...
        DARK_ELEMENTAL      = GetTableOfIDs('Dark_Elemental_einherjar'),
        ...
        LOGI_GROW           = GetTableOfIDs('Logi_grow'), -- 6x growing/self destructing
        LOGI                = GetTableOfIDs('Logi'), -- 6x non-growing
