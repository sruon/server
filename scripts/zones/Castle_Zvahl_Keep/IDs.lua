...
zones[xi.zone.CASTLE_ZVAHL_KEEP] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA             = 7248, -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7254, -- The Goblin slipped away when you were not looking...
        HOMEPOINT_SET                 = 7297, -- Home point set!
    },
    mob =
    {
