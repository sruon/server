...
zones[xi.zone.LA_THEINE_PLATEAU] =
{
    text =
    {
        ...
        RESCUE_DRILL                  = 7403,  -- Rescue drills in progress. Try to stay out of the way.
        FAURBELLANT_1                 = 7443,  -- Greetings. traveler. Sorry, I've little time to chat. I must focus on my prayer.
        FAURBELLANT_2                 = 7444,  -- Ah, the <item>! Thank you for making such a long journey to bring this! May the Gates of Paradise open to all.
        FAURBELLANT_3                 = 7445,  -- Please deliver that <item> to the high priest in the San d'Oria Cathedral.
        FAURBELLANT_4                 = 7446,  -- My thanks again for your services. May the Gates of Paradise open to all.
        ...
        TIME_ELAPSED                  = 7855,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
