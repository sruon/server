...
entity.declaredTrades =
{
...

    {
        match   = { gil = 35000 },
        acceptIf = function(player, npc)
            return player:getQuestStatus(xi.questLog.OUTLANDS, xi.quest.id.outlands.EVEN_MORE_GULLIBLES_TRAVELS) == xi.questStatus.QUEST_ACCEPTED
                and player:getCharVar('EVEN_MORE_GULLIBLES_PROGRESS') == 0
        end,
        event = {
            id     = 150,
            params = { 0, 256 },
