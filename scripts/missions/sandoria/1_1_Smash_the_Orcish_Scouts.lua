...
local completeTradeOnFinish = function(player, option, npc)
    return mission:complete(player)
end

local function orcishAxeDecls(firstId, repeatId)
    return {
        {
            ...
            event = {
                ...
                onFinish = completeTradeOnFinish,
            },
        },
    }
end
    ...
    -- and repeat completion
    {
        ...
        [xi.zone.SOUTHERN_SAN_DORIA] =
        {
            ['Ambrotien'] =
            {
                ...
                declaredTrades = orcishAxeDecls(2020, 2002),
            },

            ['Endracion'] =
            {
                onTrigger      = mission:messageText(southernSandoriaID.text.ORIGINAL_MISSION_OFFSET),
                declaredTrades = orcishAxeDecls(1020, 1002),
            },
        },
