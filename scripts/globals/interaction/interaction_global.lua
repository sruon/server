...
function InteractionGlobal.onEventFinish(player, csid, option, npc, fallbackFn)
    -- Declarative trade commits are handled in C++ (luautils::OnEventFinish)
    -- before this runs. We just dispatch the interaction lookup for any
    -- additional onEventFinish handlers tied to this csid.
