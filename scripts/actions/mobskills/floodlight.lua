...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local flashPower = 200 -- TODO: Check if it has a 10% variance like other flash effects
    ...
    xi.mobskills.mobStatusEffectMove(mob, target, xi.effect.FLASH, flashPower, 1, 20)
