...
CREATE TABLE `instance_list` (
  ...
  `music_day` smallint(3) unsigned,
  `music_night` smallint(3) unsigned,
  `battlesolo` smallint(3) unsigned,
  `battlemulti` smallint(3) unsigned,
...
-- INSERT INTO `instance_list` VALUES (5506,'lost_and_found',55,54,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (5507,'deserter',55,54,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (5508,'desperately_seeking_cephalopods',55,54,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
...
-- INSERT INTO `instance_list` VALUES (5606,'stop_the_bloodshed',56,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (5607,'defuse_the_threat',56,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (5608,'operation:snake_eyes',56,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (5609,'wake_the_puppet',56,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
...
-- INSERT INTO `instance_list` VALUES (6606,'blitzkrieg',66,52,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (6607,'marids_in_the_mist',66,52,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (6608,'azure_ailments',66,52,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
...
-- INSERT INTO `instance_list` VALUES (6905,'supplies_recovery',69,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (6906,'azure_experiments',69,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (6907,'imperial_code',69,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (6908,'red_versus_blue',69,79,30,0.000,0.000,0.000,0,NULL,NULL,NULL,NULL);
...
-- INSERT INTO `instance_list` VALUES (8600,'honor_under_fire',86,83,0,382,0,-191,74,NULL,NULL,NULL,NULL);
-- INSERT INTO `instance_list` VALUES (8601,'what_price_loyalty',86,83,0,382,0,-191,74,NULL,NULL,NULL,NULL);
