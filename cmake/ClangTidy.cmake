...
if(ENABLE_CLANG_TIDY)
  ...
  find_program(CLANG_TIDY_CACHE_COMMAND NAMES clang-tidy-cache)
  if(NOT CLANG_TIDY_COMMAND)
    ...
    # ctcache keys on the preprocessed TU, so unchanged files replay their stored output instead of re-running clang-tidy.
    if(CLANG_TIDY_CACHE_COMMAND)
      set(CMAKE_CXX_CLANG_TIDY "${CLANG_TIDY_CACHE_COMMAND};${CMAKE_CXX_CLANG_TIDY}")
    endif()
  endif()
