...
xi.settings.main =
{
    ...
    WEEKLY_EXCHANGE_LIMIT = 150000, -- Maximum amount of sparks/accolades that can be spent per week (default retail value: 100000)
    ...
    EGG_HUNT                        =
    {
        ...
        BONUS_WORDS =
        {
             CATSEYE = 4388,    -- Eggplant because of Mowford, and for the lulz
             BUNNY   = 15297,   -- Rabbit Belt
             PEEP    = 28652,   -- Hatchling Shield
             SPRING  = 3673,    -- Chocobo Carvings
             CHICK   = 11500,   -- Chocobo Beret
             GREEN   = 6008     -- Copse Candy
        },
    },
    ...
    INACTIVITY_WATCHDOG_PERIOD  = 4000,  -- Time in milliseconds which the inactivity watchdog will wait between ticks of the main loop before potentially killing the target process.
