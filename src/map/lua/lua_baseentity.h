...
public:
    ...
    void injectActionPacket(uint32 inTargetID, uint16 inCategory, ActionAnimation inAnimationID, uint16 inSpecEffect, uint16 inReaction, MSGBASIC_ID inMessage, uint16 inActionParam, uint16 inParam) const;
