...
public:
    ...
    void DropEffectsForTransition(bool logout); // Remove the effects that don't survive a zone change or logout
    auto BuildPersistRows(bool logout) -> std::vector<PersistedEffect>;
