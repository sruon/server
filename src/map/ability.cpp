...
CAbility* GetTwoHourAbility(xi::Job JobID)
{
    ...
    ShowWarning("Attempt to get two hour ability with invalid xi::Job %d.", static_cast<uint8>(JobID));
    return nullptr;
}
...
std::vector<CAbility*> GetAbilities(xi::Job JobID)
{
