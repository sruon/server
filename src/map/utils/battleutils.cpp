...
void LoadSkillTable()
{
    ...
    FOR_DB_MULTIPLE_RESULTS(rset)
    {
        ...
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::WAR)] = std::clamp<uint8>(rset->get<uint8>("war"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::MNK)] = std::clamp<uint8>(rset->get<uint8>("mnk"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::WHM)] = std::clamp<uint8>(rset->get<uint8>("whm"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::BLM)] = std::clamp<uint8>(rset->get<uint8>("blm"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::RDM)] = std::clamp<uint8>(rset->get<uint8>("rdm"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::THF)] = std::clamp<uint8>(rset->get<uint8>("thf"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::PLD)] = std::clamp<uint8>(rset->get<uint8>("pld"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::DRK)] = std::clamp<uint8>(rset->get<uint8>("drk"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::BST)] = std::clamp<uint8>(rset->get<uint8>("bst"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::BRD)] = std::clamp<uint8>(rset->get<uint8>("brd"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::RNG)] = std::clamp<uint8>(rset->get<uint8>("rng"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::SAM)] = std::clamp<uint8>(rset->get<uint8>("sam"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::NIN)] = std::clamp<uint8>(rset->get<uint8>("nin"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::DRG)] = std::clamp<uint8>(rset->get<uint8>("drg"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::SMN)] = std::clamp<uint8>(rset->get<uint8>("smn"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::BLU)] = std::clamp<uint8>(rset->get<uint8>("blu"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::COR)] = std::clamp<uint8>(rset->get<uint8>("cor"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::PUP)] = std::clamp<uint8>(rset->get<uint8>("pup"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::DNC)] = std::clamp<uint8>(rset->get<uint8>("dnc"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::SCH)] = std::clamp<uint8>(rset->get<uint8>("sch"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::GEO)] = std::clamp<uint8>(rset->get<uint8>("geo"), 0, 11);
        g_SkillRanks[SkillID][static_cast<uint8>(xi::Job::RUN)] = std::clamp<uint8>(rset->get<uint8>("run"), 0, 11);
    }
}
...
uint8 GetSkillRank(SKILLTYPE SkillID, xi::Job JobID)
{
    return g_SkillRanks[SkillID][static_cast<uint8>(JobID)];
}
...
uint16 GetMaxSkill(SKILLTYPE SkillID, xi::Job JobID, uint8 level)
{
    ...
    return g_SkillTable[std::clamp<uint8>(level, 0, maxLevel)][g_SkillRanks[SkillID][static_cast<uint8>(JobID)]];
}
