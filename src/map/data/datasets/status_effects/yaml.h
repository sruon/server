...
template <>
struct glz::meta<xi::data::datasets::status_effects::wire::StatusEffectsFile> : xi::data::yaml::DatasetRootSchema
{
    using T                     = xi::data::datasets::status_effects::wire::StatusEffectsFile;
    static constexpr auto value = glz::object("meta", glz::skip{}, "status_effects", &T::status_effects);
};
...
template <>
struct glz::json_schema<xi::data::datasets::status_effects::wire::StatusEffectsFile>
{
    glz::schema status_effects = xi::data::yaml::namedMapDoc("Status effects keyed by their canonical name.");
};
