...
// Replace an inherited value when the child overrides it.
template <class T>
...
struct Dataset
{
    ...
    using YamlFile = wire::EcosystemFile;
    ...
    static auto decode(std::string_view yaml) -> Records;
};
