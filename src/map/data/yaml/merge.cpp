...
// Parse one YAML document into the value used by Glaze's patch API.
...
// Read one data file into memory.
...
// Read the core file and any module patches before binding it.
