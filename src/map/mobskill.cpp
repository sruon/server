...
{
    return m_Message == MSGBASIC_ABILITY_MISSES || m_Message == MSGBASIC_USES_SKILL_MISSES ||
           m_Message == MSGBASIC_SHADOW_ABSORB || m_Message == MSGBASIC_TARGET_ANTICIPATES || m_Message == MSGBASIC_RANGED_ATTACK_MISS;
}
...
{
    return m_Message == MSGBASIC_USES_ABILITY_TAKES_DAMAGE || m_Message == MSGBASIC_USES_SKILL_TAKES_DAMAGE ||
           m_Message == MSGBASIC_USES_ABILITY_RESISTS_DAMAGE || m_Message == MSGBASIC_TARGET_TAKES_DAMAGE ||
           m_Message == MSGBASIC_USES_SKILL_HP_DRAINED || m_Message == MSGBASIC_USES_SKILL_MP_DRAINED || m_Message == MSGBASIC_USES_SKILL_TP_DRAINED;
}
