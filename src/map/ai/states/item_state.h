...
protected:
    ...
    // Custody for the duration of the use. Committed on a successful
    // FinishItem; auto-rolled-back by the dtor on every other exit
    // path (interrupt, cancel, disconnect, zone change, exception).
