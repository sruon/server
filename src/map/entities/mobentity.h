...
public:
    ...
    // m_Weapons on CBattleEntity is a raw aliasing view; mobs own
    // the storage here since they have no inventory container.
...
private:
    ...
    std::array<std::unique_ptr<CItemWeapon>, 4> ownedWeapons_{};
};
